...
static uint8_t cantidad_maxima_devices = 4; // Para recorrer el array necesito contemplar el 0 como "cantidad_minima_devices" 
static uint8_t cantidad_minima_devices = 0;
...
//static void showProductOK1 (void) {
	//displayRAM_cargarDR(display_producto_ok1, 0);
	//display_productName(3);
//}

//static void showProductOK2 (void) {
	//displayRAM_cargarDR(display_producto_ok2, 0);
	//
	//displayRAM_putU8BCD(7, (id[0] & 0xf0) >> 4, false);
	//displayRAM_putU8BCD(8, id[0] & 0x0f, false);
	//displayRAM_putU8BCD(9, (id[1] & 0xf0) >> 4, false);
	//displayRAM_putU8BCD(10, id[1] & 0x0f, false);
	//displayRAM_putU8BCD(11, (id[2] & 0xf0) >> 4, false);
	//displayRAM_putU8BCD(12, id[2] & 0x0f, false);
	//displayRAM_putU8BCD(13, (id[3] & 0xf0) >> 4, false);
	//displayRAM_putU8BCD(14, id[3] & 0x0f, false);
	//
	//displayRAM_putU8Hex(19, versionMayor, false);
	//displayRAM_putU8Hex(21, versionMenor/10, false);
	//displayRAM_putU8Hex(22, versionMenor%10, false);
	//
	//if ( bg96Signal == 100 ) {
		//displayRAM_setChar(28, '1');
		//displayRAM_setChar(29, '0');
		//displayRAM_setChar(30, '0');
	//}
	//else {
		//displayRAM_setChar(28, " ");
		//displayRAM_putU8Hex(29, bg96Signal/10, false);
		//displayRAM_putU8Hex(30, bg96Signal%10, false);
	//}
	//displayRAM_cargarComando(TLCD_PERMANENT);
//}